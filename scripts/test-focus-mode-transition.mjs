...
test("target readiness failure recovers before transparent prewarm", async () => {
  const h = harness();
...
test("transparent prewarm failure recovers the previous renderer and native presentation", async () => {
  const h = harness();
