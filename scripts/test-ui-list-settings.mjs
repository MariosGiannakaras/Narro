...
for (const [haystack, needle, label] of [
  ...
  [capture, 'foreach ($listSettingsMode in @("archive", "archived", "delete"))', "list settings Edge capture mode loop"],
  [capture, '$listSettingsLabel = "list-settings-$listSettingsMode-$theme"', "mode/theme Edge capture label"],
  [capture, '$listSettingsUrl = "$baseUrl/list-settings-fixture.html?theme=$theme&mode=$listSettingsMode"', "list settings fixture capture URL"],
