...
for (const [haystack, needle, label] of [
  ...
  [liveTime, "TaskBindingMismatch", "live Time Taken stale-task error"],
  [liveTime, "ExpectedTimeTakenMismatch", "live Time Taken stale-total error"],
  ...
  [runtime, "estimate_below_elapsed_enters_time_up_without_losing_work", "expired EST no-time-loss regression"],
