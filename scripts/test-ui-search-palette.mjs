...
for (const [haystack, needle, label] of [
  ...
  [palette, 'data-search-match="true"', "matched-substring highlight identity"],
  [palette, "<HighlightedMatch text={list.title} query={queryToken} />", "list matched-text highlighting"],
  [palette, "<HighlightedMatch text={task.title} query={queryToken} />", "task matched-text highlighting"],
  ...
  [palette, "estSeconds: null", "quick task create default EST"],
  [palette, "insertAtTop: false", "quick task create append semantics"],
  [shell, 'destination === "search"', "Search utility overlay routing"],
  [shell, 'resolveInAppShortcut(event)', "shared main-app shortcut resolver"],
  [shell, 'shortcut === "search"', "main-app Ctrl+F search routing"],
