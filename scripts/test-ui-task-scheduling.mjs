...
for (const [haystack, needle, label] of [
  ...
  [boardSchedule, "replace_existing_tasks(&mut connection", "special replace-existing transaction path"],
  [boardSchedule, "update_recurrence_rule(&mut connection", "non-replace recurrence update path"],
  [boardSchedule, "delete_recurrence_rule(&mut connection", "authoritative recurrence removal path"],
