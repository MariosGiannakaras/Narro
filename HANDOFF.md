...
PR #132 closes a remaining source gap in item 12: if the requested DPI-scaled outer size itself exceeds the selected work area, native code fits both axes before clamping, checks the actual result, and uses existing resize rollback on failure. Expanded controls wrap and scroll on narrow/short viewports; local Edge rendering at 240×200 confirmed the last subtask remains reachable. The first PR CI #496 failed at an unrelated scheduling fixture ready race after preflight and Floating Timer captures passed. The race was reproduced locally; the capture now performs one bounded ready-marker recapture. Final exact PR head `2e4cf9e7edb5bf0021771d55d0df2640503dddf7` passed Windows CI #497 / run `35979772197` / job `107564048044`. Expected-head guarded squash merge `59bdc2dc4d4c6ed7b871bbce0c224e532b51e075` passed resulting-main CI #498 / run `35981558967` / job `107574406254`. New runtime artifact `10801570232`, digest `sha256:e096decb5c9fc3f8bd179fadccfd42b1a075c4722c1b10b9d0329ec6dd0d4f77`; visual artifact `10800469073`, digest `sha256:0f7631b63b97d0012130c2a8e214ca38918c434d89c266eadcfc20eceeebb149`. Physical item 12 remains open.

## NEXT AGENT ACTION

1. The next independent M7 action needs physical Windows evidence. Use the exact resulting-main CI #498 source `59bdc2dc4d4c6ed7b871bbce0c224e532b51e075` and runtime artifact `10801570232` with `docs/M7_FLOATING_RUNTIME_VALIDATION.md` for one consolidated session covering items 7–14. Verify the installed/running executable belongs to this artifact before attributing observations to it.
