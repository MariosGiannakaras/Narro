...
- [ ] Implement Focus Panel <-> Floating Timer content transition with short one-shot opacity/transform motion; do not animate native window geometry in a high-frequency JS loop.
  ...
  - [ ] Native hidden-resize corrective candidate: PR #125 exact head `62e40ca34c86fe5fc19da447448aa1d540e80754`; Windows CI #481 is running. Do not count this as validated until exact-head CI, guarded merge and resulting-main CI pass.
