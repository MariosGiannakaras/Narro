...
PR #132 extends item 12 for monitor work areas smaller than the requested DPI-scaled Timer: native outer size is fitted before placement, and expanded content stays reachable through scrolling and a wrapped action strip. Its first PR CI #496 passed preflight but failed on a premature, unrelated scheduling visual fixture capture. The capture race was reproduced locally and fixed with one bounded ready-marker recapture. Final PR head `2e4cf9e7edb5bf0021771d55d0df2640503dddf7` passed Windows CI #497 / run `35979772197` / job `107564048044`. Guarded squash merge `59bdc2dc4d4c6ed7b871bbce0c224e532b51e075` passed resulting-main CI #498 / run `35981558967` / job `107574406254`. Main runtime artifact `10801570232`, digest `sha256:e096decb5c9fc3f8bd179fadccfd42b1a075c4722c1b10b9d0329ec6dd0d4f77`; visual artifact `10800469073`, digest `sha256:0f7631b63b97d0012130c2a8e214ca38918c434d89c266eadcfc20eceeebb149`. This supersedes earlier M7 source candidates for the consolidated physical session. The item 12 physical gate remains open.
