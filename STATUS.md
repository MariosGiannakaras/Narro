...
PR #136 completes Panel/Timer and expanded/collapsed Timer motion by awaiting the actual opacity transition or a verified no-transition end state. A cancelled transition that stops before the required boundary reports an error and releases the pending lock. A post-commit entrance failure preserves the native expanded state in the renderer. The async completion helper has executable behavioral tests; source integration contracts and local frontend preflight passed. Exact PR head `41618d984e9e7c030f60b15daa5097ffae0b6e3a` passed Windows CI #501 / run `36010919741` / job `107671092266`, including preflight, visual fixtures, and Tauri release. Expected-head guarded merge `0fc7401eed306024f8114bb2d5a8c00380541e9a` has the identical tree `f7dd73ab77556ab3c078f4670e6051d07c98e8f3`. Automatic main CI #502 was cancelled after that identity check to avoid an equivalent second build. PR runtime artifact `10813650281`, digest `sha256:da1b4decb8f95dc58455339b6ea9678d004434f46d19d07e286722eecdb4d526`; visual artifact `10812927597`, digest `sha256:3a7e48a15b5c2a632d3c6f0e4bc877b6dcdcb1e15d279cce334346261d8abdd4`. Physical Windows gates remain open; use `docs/M7_FLOATING_RUNTIME_VALIDATION.md` for the consolidated session.
