...
PR #134 closes a topology recovery gap in items 10 and 12: a visible Timer is now fitted and repositioned after display changes even without a saved placement, and restore rechecks actual outer geometry after a DPI-dependent move. Native mode presentation rolls back geometry, visibility, topmost, and mode on failure. Exact head `44ad3c91f3af1f7f50666afc1802afba3808cc26` passed Windows CI #499 / run `35985228076` / job `107586210179`; guarded squash merge `c9ae5911aeacdd2f6604f41d35968ce691131b43` has the identical tree `1e770357a7e69fa3771283c3b3ba5815231accf2` and passed resulting-main CI #500 / run `35986934404` / job `107591702897`. Main runtime artifact `10803027598`, digest `sha256:fbb99fa6058074bf3704b19f0bb33a4feb4b57ea9443227f2afdd3393ccf5ccc`; visual artifact `10803365142`, digest `sha256:022b965346bfb2a4da17ae30b75f6477a5160f9415eb115f50deec2ecb5ce208`. Physical Windows gates remain open; use `docs/M7_FLOATING_RUNTIME_VALIDATION.md` for the consolidated session.

Earlier PR #125–#132 implementation and artifact evidence is preserved in immutable `work-log/` entries. Those artifacts are superseded for the next physical session by the current source above.
